...
export const handleSubmit = async (event: any, title: string, authors: string, file: Media | null, coverImage: Media | null, introduction: string, description: string, interestArea: InterestArea | null, declarationFile: Media | null, isPrivacyChecked: boolean, setIsSubmitting: (value: boolean) => void) => {
