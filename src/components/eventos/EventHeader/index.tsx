...
export default function EventHeader({ event }: { event: Event }) {
    ...
    function capitalizeDateParts(dateString: string) {
        return dateString.replace(/\b(?!de\b)\w/g, (char) => char.toUpperCase());
    }
            ...
            <Grid columns="abcd">
                ...
                <div className={styles.info}>
                    ...
                    <div className={styles.date}>
                        <div><strong>Início</strong>: {capitalizeDateParts(start_date.toFormat('cccc, d \'de\' MMMM \'de\' yyyy'))}</div>
                        <div><strong>Fim</strong>: {capitalizeDateParts(end_date.toFormat('cccc, d \'de\' MMMM \'de\' yyyy'))}</div>
                    </div>
