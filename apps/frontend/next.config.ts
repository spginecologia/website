...
const nextConfig: NextConfig = {
	env: {
		NEXT_PUBLIC_CLOUDFLARE_TURNSTILE_SITE_KEY: process.env.NODE_ENV === 'development' ? process.env.NEXT_PUBLIC_CLOUDFLARE_TURNSTILE_SITE_KEY : '0x4AAAAAAA4UHAUCG1nzvjW5',
