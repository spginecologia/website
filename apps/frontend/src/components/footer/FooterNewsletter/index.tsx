...
import { NewsletterDefault } from '@/services/payload/collections/Newsletter/default';
import { NewsletterValidation } from '@/services/payload/collections/Newsletter/validation';
