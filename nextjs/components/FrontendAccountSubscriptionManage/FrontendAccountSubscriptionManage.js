...
export default function FrontendAccountSubscriptionManage({ status }) {
  ...
  switch (status) {
    case 'active':
      return (
        <a className={`${styles.container} ${styles.active}`} href="/api/users/subscription/manage">
    ...
    case 'incomplete':
      return (
        <a className={`${styles.container} ${styles.pastDue}`} href="/api/users/subscription/manage">
          <IconCreditCardPay size={18} />
    ...
    case 'incomplete_expired':
      return (
        <a className={`${styles.container} ${styles.canceled}`} href="/api/users/subscription/renew">
          <IconCreditCardPay size={18} />
    ...
    default:
      return (
        <a className={`${styles.container} ${styles.notFound}`} href="/api/users/subscription/renew">
          <IconCreditCardPay size={18} />
