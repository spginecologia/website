      ...
      <form onSubmit={form.onSubmit(async () => await handleSave())}>
        <Section>
          ...
          <SimpleGrid cols={3}>
            ...
            <Select label={t('form.lang.label')} placeholder={t('form.lang.placeholder')} nothingFound={t('form.lang.nothingFound')} data={[{ value: 'pt', label: 'Português (Portugal)' }]} {...form.getInputProps('lang')} searchable readOnly={isReadOnly} />
